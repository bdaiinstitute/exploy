...
# (num_instances, num_bodies, 3). mjlab only exposes per-body velocities in the world frame, so
# these are derived from the world-frame link velocities and the body orientations, and
# materialized on the ``EntityDataSource`` during export (see ``add_body_vel``).
